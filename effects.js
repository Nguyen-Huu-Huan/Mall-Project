...
function add_to_cart(item) {
    if (islogin == 'true') {
        ...
        cart_item[item] = [document.querySelector(".dunklowblack>div>div").children[1].children[1].textContent, count, document.querySelector(".dunklowblack>div>div>div>img").getAttribute('src')]
