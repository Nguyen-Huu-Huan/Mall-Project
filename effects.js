        ...
        if (Object.keys(cart_item).length==0) {
            ...
            [dunklowblack_input,airforceone_input].forEach((input_number)=>{
                input_number.addEventListener("input", function() {
                    item_div_1_2_dunklowblack.innerHTML = (((JSON.parse(localStorage.getItem('Dunk Low Black'))||0)[0]||0)*dunklowblack_input) + "$"
                    item_div_1_2_airforceone.innerHTML = (((JSON.parse(localStorage.getItem('Air Force One'))||0)[0]||0)*airforceone_input) + "$"
