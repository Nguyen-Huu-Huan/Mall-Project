                        ...
                        <a class="store-thumbnail" href="store/store-home.php">
                            <figure class="col-20 hover-shadow">
                                ...
                                <figcaption class="text-center">
                                    <a href="store/store-home.php" class="text-medium text-bold" alt="Cotton On">Cotton On Body</a>
                                </figcaption>
                            </figure>
                        </a>
                        <a class="store-thumbnail" href="store/store-home.php">
                            <figure class="col-20 hover-shadow">
                                ...
                                <figcaption class="text-center">
                                    <a href="store/store-home.php" class="text-medium text-bold" alt="Goldern Nails">Golden Nails</a>
                                </figcaption>
                            </figure>
                        </a>
                        <a class="store-thumbnail" href="store/store-home.php">
                            <figure class="col-20 hover-shadow">
                                ...
                                <figcaption class="text-center">
                                    <a href="store/store-home.php" class="text-medium text-bold" alt="innisfree">Innisfree</a>
                                </figcaption>
                            </figure>
                        </a>
                    </div>
