...
<head>
    ...
    <title>Mallux Forgot Password| Online Shopping Mall</title>
            ...
            <div class="row">
                ...
                <div class="col-60">
                    <form>
                        ...
                        <br>
                        <input type="text" id="fname" name="fname" value="" required placeholder="*required">
                        <br>
                        <input type="submit" name="" value="Verify" class="small-container btn text-medium">
                    </form>
                </div>
            </div>
        </main>
