    ...
    <div class="mobile-menu-opened">
        ...
        <section class="dunklowblack">
            <div class="small-container">
                <div class="row">
                    <div class="col-50">
                        <img src="../images/dunklowblack6.jpg" alt="Dunk Low Black" width="100%">
                        <div class="row">
                            <div class="col-17">
                                <img src="../images/dunklowblack1.jpg" alt="Dunk Low Black" width="100%">
                            </div>
                            <div class="col-17">
                                <img src="../images/dunklowblack2.jpg" alt="Dunk Low Black" width="100%">
                            </div>
                            <div class="col-17">
                                <img src="../images/dunklowblack3.jpg" alt="Dunk Low Black" width="100%">
                            </div>
                            <div class="col-17">
                                <img src="../images/dunklowblack4.jpg" alt="Dunk Low Black" width="100%">
                            </div>
                            <div class="col-17">
                                <img src="../images/dunklowblack5.jpg" alt="Dunk Low Black" width="100%">
                            </div>
                        </div>
                    </div>
                    <div class="col-45">
                        <h2>Dunk Low Black</h2>
                        <h3 class="color-red">$130</h3>
                        <select>
                    ...
                    <option>EU 44</option>
                        ...
                        <h3> <a href="#" class="btnnike btn add-to-cart" onclick="add_to_cart('Dunk Low Black', event)">Add to cart</a>
                            <a href="../order-placement.php" class="btnnike btn">Buy Now</a>
                        </h3>
                        <h3>Product details</h3>
                        <p>Originally created for the hardwood, the Dunk later took to the streets—and as they say, the rest is history. More than 35 years after its debut, the silhouette still delivers bold, defiant style and remains a coveted look for
                            crews across both sport and culture. Now, the university-hoops OG returns covered in crisp material overlays with heritage-inspired colour-blocking. Modern footwear technology brings the design's comfort into the 21st century,
                            while a contrasting combination of black and white gives this make-up a clean feel.</p>
                    </div>
                </div>
            </div>
        </section>
