...
<head>
    ...
    <title>Mallux Beauty | Online Shopping Mall</title>
...
<body class="index">
    ...
    <div class="mobile-menu-opened">
        ...
        <!--Contact-->
        <main>
            <section class="beauty-stores">
                <div class="small-container">
                    <div class="row">
                        <h1 class="text-center section-title">Beauty</h1>
                    </div>
                    <div class="row">
                        <a class="store-thumbnail" href="store/store-home.html">
                            <figure class="col-20 hover-shadow">
                                <img src="images/cottononbody.png" alt="Cotton On Body">
                                <figcaption class="text-center">
                                    <a href="store/store-home.html" class="text-medium text-bold" alt="Cotton On">Cotton On Body</a>
                                </figcaption>
                            </figure>
                        </a>
                        <a class="store-thumbnail" href="store/store-home.html">
                            <figure class="col-20 hover-shadow">
                                <img src="images/golden nails.png" alt="adidas">
                                <figcaption class="text-center">
                                    <a href="store/store-home.html" class="text-medium text-bold" alt="Goldern Nails">Golden Nails</a>
                                </figcaption>
                            </figure>
                        </a>
                        <a class="store-thumbnail" href="store/store-home.html">
                            <figure class="col-20 hover-shadow">
                                <img src="images/innisfree.jpg" alt="Innisfree">
                                <figcaption class="text-center">
                                    <a href="store/store-home.html" class="text-medium text-bold" alt="innisfree">Innisfree</a>
                                </figcaption>
                            </figure>
                        </a>
                    </div>
